...
> 文档ID: ads-publisher-service-native
> 版本: V215
> 更新时间: 2026-06-08 05:31:39
...
#### 场景介绍
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/XN5raVmcT7imOjccdIKq_g/zh-cn_image_0000002592219198.png?HW-CC-KV=V1&HW-CC-Date=20260611T154120Z&HW-CC-Expire=86400&HW-CC-Sign=B09E0C77DC5457ED8229BFB78C03C3E5BBC20FBACAB42F0AC89FF4AD39C7469B)
...
| adId | string | 是 | 广告位ID。 |
  ...
  - 如果仅调测广告，可使用测试广告位ID：s7moc0jc6m（原生视频），h8asowxwhq（原生大图），k94abyn2z4（原生小图），o7dj7qsbvy（原生三图）。
...
struct Index {
  ...
  private async loadAd(...adIds: string[]): Promise {
    // 广告请求参数
