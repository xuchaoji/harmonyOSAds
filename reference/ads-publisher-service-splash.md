...
> 文档ID: ads-publisher-service-splash
> 版本: V215
> 更新时间: 2026-06-08 05:32:20
...
struct Index {
  ...
  private async setWindowLayoutFullScreen(isLayoutFullScreen: boolean): Promise {
    try {
  ...
  // ...
  private async loadAd(adId: string): Promise {
    // 广告请求参数
