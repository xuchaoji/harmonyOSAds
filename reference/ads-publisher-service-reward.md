...
> 文档ID: ads-publisher-service-reward
> 版本: V215
> 更新时间: 2026-06-08 05:31:57
...
# 激励广告
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/7b/v3/X8WuIhrKSJmHklJQJYKN8Q/zh-cn_image_0000002592379132.png?HW-CC-KV=V1&HW-CC-Date=20260611T154120Z&HW-CC-Expire=86400&HW-CC-Sign=1A67547BC16F415DAB720DDCF0CCB54EF7206FE78D88C57E0E11884EBD07E402)
...
```
      ...
      -        获取OAID。
       ...
       如何获取OAID参见[获取OAID信息](oaid-service.md)。
               ...
               ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/95/v3/LJnTZKkuSC6Kp_3nsw1NQw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260611T154120Z&HW-CC-Expire=86400&HW-CC-Sign=A37EF62CE2958DB5A69E04FEE3128866DC56674BE4CD245741CA3070EA758A94)                  使用以下示例中提供的测试广告位时，必须先获取OAID信息。
...
```
      ...
      -        事件订阅。
       ...
       在订阅到公共事件后，可以从[CommonEventData](api/js-apis-inner-commonevent-commoneventdata.md)的parameters参数中获取激励广告页面变化状态和奖励信息。
        ...
        if (err) {
          ...
          switch (status) {
            ...
            case 'onAdClose':
              ...
              break;
            case 'onAdReward':
              const rewardData: Record = commonEventSubscriber?.parameters?.[KEY_REWARD_DATA];
...
```
     ...
     ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/38/v3/XwoCDVLMSFOh6VdOFq7scw/zh-cn_image_0000002622858639.png?HW-CC-KV=V1&HW-CC-Date=20260611T154120Z&HW-CC-Expire=86400&HW-CC-Sign=02F6668FB1AD06AE4B9E38B3AE0C6B9AE12F7339CC914CB04674474A83771014)
      ...
      -        对于某些应用而言，奖励是否达到发放条件非常重要，用户可适当接受延迟。这时，推荐做法是等待服务器端回调完成验证，再向用户发放奖励。
           ...
           ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/8b/v3/4ORFFX8BQomOdjQmGuikiw/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260611T154120Z&HW-CC-Expire=86400&HW-CC-Sign=6DC299F288741B3879AF72E46E7C2485B5ACB8DBB0F225D919B8BA27F249D25C)              App上架至华为应用市场（AppGallery）时间超过12小时才可以收到回调。
      ...
      -        设置激励广告的奖励配置。
       ...
       ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/f3/v3/q9sVPMn2SEKNYaqR5RZmxQ/zh-cn_image_0000002622698761.png?HW-CC-KV=V1&HW-CC-Date=20260611T154120Z&HW-CC-Expire=86400&HW-CC-Sign=574EBA979C592C9019BBF5E404E85DC2B7D90C2DC939DA8F50791BD38C7B31FD)

      -        （可选）设置自定义数据customData和userId。

       您在[展示广告第2点](ads-publisher-service-reward.md)之前可以设置自定义数据customData和userId。示例代码如下所示：
...
```
               ![](https://contentcenter-vali-drcn.dbankcdn.cn/pvt_2/DeveloperAlliance_scene_100_1/d7/v3/bhYJZ3-oQISZ4FVFSGgwqQ/note_3.0-zh-cn.png?HW-CC-KV=V1&HW-CC-Date=20260611T154120Z&HW-CC-Expire=86400&HW-CC-Sign=4590E3259DA7BB2D1F458CD9184B573221502367737647DF909769BDD584D998)                  如果没有设置customData和userId，不影响发放奖励事件上报但是服务端验证的参数中没有这两个字段。如果设置customData和userId，必须在展示广告之前设置并且URLEncode之后，长度不超过1024个字符，否则影响服务端验证。
...
public static String bytesToHexString(byte[] bytes) {
  ...
  for (int i = 0; i 中国境内（香港特别行政区、澳门特别行政区、中国台湾除外）：[https://ppscrowd-drcn.op.hicloud.com/action-lib-track/publickeys](https://ppscrowd-drcn.op.hicloud.com/action-lib-track/publickeys)
